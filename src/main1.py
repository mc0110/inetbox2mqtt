...
HA_CONFIG = {
    ...
    "target_temp_aircon":    ['homeassistant/sensor/target_temp_aircon/config', '{"name": "truma_target_temp_aircon", "model": "' + HA_MODEL + '", "sw_version":"' + HA_SWV + '", "device_class": "temperature", "unit_of_measurement": "°C", "state_topic": "' + HA_STOPIC + 'target_temp_aircon"}'],
    ...
    "aircon_operating_mode": ['homeassistant/sensor/aircon_operating_mode/config', '{"name": "truma_aircon_operating_mode", "model": "' + HA_MODEL + '", "sw_version":"' + HA_SWV + '", "state_topic": "' + HA_STOPIC + 'aircon_operating_mode"}'],
    "aircon_vent_mode":      ['homeassistant/sensor/aircon_vent_mode/config', '{"name": "truma_aircon_vent_mode", "model": "' + HA_MODEL + '", "sw_version":"' + HA_SWV + '", "state_topic": "' + HA_STOPIC + 'aircon_vent_mode"}'],
    "operating_status":      ['homeassistant/sensor/operating_status/config', '{"name": "truma_operating_status", "model": "' + HA_MODEL + '", "sw_version":"' + HA_SWV + '", "state_topic": "' + HA_STOPIC + 'operating_status"}'],
    ...
    "set_target_temp_aircon":['homeassistant/select/target_temp_aircon/config', '{"name": "truma_set_aircontemp", "model": "' + HA_MODEL + '", "sw_version":"' + HA_SWV + '", "command_topic": "' + HA_CTOPIC + 'target_temp_aircon", "options": ["16", "18", "20", "22", "24", "26", "28"] }'],
    ...
    "set_aircon_mode":       ['homeassistant/select/aircon_mode/config', '{"name": "truma_set_aircon_mode", "model": "' + HA_MODEL + '", "sw_version":"' + HA_SWV + '", "command_topic": "' + HA_CTOPIC + 'aircon_operating_mode", "options": ["off", "vent", "cool", "hot", "auto"] }'],
    "set_vent_mode":         ['homeassistant/select/vent_mode/config', '{"name": "truma_set_vent_mode", "model": "' + HA_MODEL + '", "sw_version":"' + HA_SWV + '", "command_topic": "' + HA_CTOPIC + 'aircon_vent_mode", "options": ["low", "mid", "high", "night", "auto"] }'],
